...
const Mint: NextPage = () => {
  ...
  if (
    ...
    content = {
      ...
      text:
        'For updates on when the next entry is, follow us on Twitter and join our Discord.',
      buttonA: !user
        ? {
            click: openModal,
            text: 'Log In'
  ...
  // Profile is not complete
    ...
    content = {
      ...
      text:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vel hendrerit ante. Maecenas ligula urna, laoreet eu rhoncus sed, interdum non ante pellentesque ',
      buttonA: {
